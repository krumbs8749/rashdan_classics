...
import { Box, Typography, Grid, Container, Paper, useMediaQuery, useTheme } from "@mui/material";
...
const PaperItem: React.FC<PaperItemProps> = ({ icon, title, description }) => (
  <Paper elevation={3} sx={{ p: 3, textAlign: "center", borderRadius: "10px", minWidth: "250px" }}>
    {icon}
    ...
    <Box sx={{ py: 6, background: "white" }}>
      <Container>
        ...
        <Typography variant="body1" textAlign="center" sx={{ mb: 4 }}>
          ...
          is a premier destination for discerning collectors and enthusiasts seeking the finest in curated and exclusive
          government car plates. With a commitment to excellence and a keen eye for rarity,{" "}
          <b>
            <i>Rashdan Classic</i>
          </b>{" "}
          offers a unique selection of distinctive number plates that embody prestige and exclusivity. Each plate in our
          collection is carefully chosen for its historical significance, aesthetic appeal, and rarity, ensuring that our
          clients receive only the most distinguished pieces.
        </Typography>
